...
#     try:
#         (ggplot(df)+geom_histogram(aes(variavel))).save(path+f"/output/descritiva/{variavel}.png", dpi = 300)
#     except:
...
fig.savefig(path+f"/output/descritiva/corrplot_log.svg", format='svg', dpi=1200)
